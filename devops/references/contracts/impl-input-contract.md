...
- Impl artifacts live in the standalone location `./artifacts/impl/`. In orchestrated runs, Orch passes the exact upstream Impl artifact paths separately. `HARNESS_ARTIFACTS_DIR` still points to DevOps's own output directory.
